Hello!! First of all I want to thank you for yor time!!
...
--->The file with that contains the project has inside the json archive it is importan to be at the same file the project and the json in order to run correctly. Thus run the program from the file that was when  you  donwloaded
